...
## Disable some typing preferences as it’s annoying when typing code
...
## disable smart zoom single tap (cause right click delay)
...
defaults write com.apple.universalaccess.plist 'mouseDriverCursorSize' 2.0
...
chflags hidden ~/{Movies,Music,Pictures,Documents,Applications,Public}
chmod 000 ~/{Movies,Music,Pictures,Documents,Applications,Public}
...
## hide OSX useless default folders from Finder
###############################################################################
...
defaults write com.apple.dock autohide-delay -float 60 && defaults write com.apple.dock autohide-time-modifier -float 0.4 && killall Dock # Arm based macs
...
## 	do shell script "open '$HOME/.config/" & themeName & ".terminal'"
